snake_package\src\components\Fuck

Fuck.js
```js
/**
 * Created by jiang on 2017/9/14.
 */
import React from 'react';

export default () => <div>fuck</div>;

```


snake_package\src\components\ThreeBg
